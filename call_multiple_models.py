...
# asking ChatGPT
def call_evaluate_loop(prompt: str, model_name: str = "gpt-4", max_call: int = 5, prompt_ver: str = "v4"):
    messages = [
        {"role": "system", "content": "You are a helpful assistant who is an expert in biology ."},
    ...
    for i in range(max_call):
        ...
        script_path = prepare_python_script(filepath, prompt_ver)
...
if __name__ == "__main__":
    ...
    for prompt_version in prompt_versions:
        ...
        clean_up_dir(f"./question_and_answer/{prompt_version}/")
        clean_up_dir("./table/")
